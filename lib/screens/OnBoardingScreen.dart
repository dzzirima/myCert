...
import 'package:my_cert/utils/constants.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget _onboard(String? atsign, String text) {
    var _serverDemoService = ClientService.getInstance();

    _serverDemoService.resetInstance();
    return ElevatedButton(
      onPressed: () async {
        var atClientPreference = await _serverDemoService.getAtClientPreference(cramSecret: '');
        Onboarding(
          atsign: atsign,
          ...
          onboard: (value, atsign) {
            //_serverDemoService.postOnboard(value, atsign);
            print('atsign $atsign');
            if (atsign != null) {
